...
public class GradeServiceImpl implements GradeService {
    ...
    @Override
    public GradeDao getRepository() {
        return gradeDao;
    }

    @Override
    public Page<Grade> findByCondition(Grade grade, SearchVo searchVo, Pageable pageable) {

        return gradeDao.findAll(new Specification<Grade>() {
            @Nullable
            @Override
