...
public class XbootGenerator {
     ...
     * 建议仅需修改
     */
    private static final String className = "Grade";

    /**
     * 类说明描述
     * 建议仅需修改
     */
    private static final String description = "年级类";

    /**
     * 作者名
     * 建议仅需修改
     */
    private static final String author = "SuGar";
     ...
     * 下方请根据需要修改
     */
    private static final String tablePre = "s_";
